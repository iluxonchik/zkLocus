import { CoordinatesInPolygon } from './zkprogram/Geography.js';
import { NoncedGeographicalPoint, ThreePointPolygon } from './model/Geography.js';
import { GeographicalPoint } from './model/Geography.js';
import { Field, Mina, Int64 } from 'o1js';
...
const uint1 = Int64.from(-5);
const uint2 = Int64.from(5);
console.log('Performing multiplication...');
const uint3 = uint1.mul(uint2);
...
const uint4 = Int64.from(1);
const uint5 = Int64.from(2);
const uint6 = uint4.div(uint5);
const uint7 = uint6.mul(uint5);
